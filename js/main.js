...
// подмена кнопки к1
function myFunction_ChangeK1() {
    var r = myFunction_Randome_0_7();
    if (r===0) {k1 = 100;
...
//число рандом 0-7
function myFunction_Randome_0_7(){
    var f = Math.random();
    console.log (f);
    f = (f*50);
    f = (f/6>>0);
